...
const CONTENT = {
  ...
  'pos-card': {
    ...
    steps: [
      ...
      { text: '롯데카드일 경우 에누리 팝업창이 나오면 적용할 <strong>에누리를 선택</strong>합니다.', image: 'pos-card-step5.png' },
      { text: '<strong>결제금액</strong>과 <strong>할부기간</strong>을 입력합니다.', image: 'pos-card-step6.png' },
      { text: '에누리 창이 뜨면 원하는 <strong>에누리를 선택</strong>합니다.', image: 'pos-card-step7.png' },
      { text: '<strong>결제 금액</strong> 및 <strong>할부 기간</strong>을 확인합니다.', image: 'pos-card-step8.png' },
      { text: '고객의 <strong>전자서명</strong>을 등록하고 <strong>확인</strong>을 클릭합니다.', image: 'pos-card-step9.png' },
    ],
  },
  ...
  'pos-giftcard': {
    ...
    steps: [
      ...
      { text: '<strong>결제</strong>를 클릭합니다.', image: 'pos-giftcard-step6.png' },
      { text: '상품권 거스름 기준에 따라 현금/상품권으로 자동 구분하여 처리됩니다.', image: 'pos-giftcard-step7.png' },
      { text: '<strong>등록</strong>을 클릭합니다.', image: 'pos-giftcard-step8.png' },
    ],
  },
  ...
  'pos-mobile-giftcard': {
    ...
    steps: [
      ...
      { text: '모바일 상품권 <strong>번호</strong>와 <strong>결제금액</strong>을 입력합니다.', image: 'pos-mobile-giftcard-step5.png' },
      { text: '<strong>등록</strong>을 클릭합니다.', image: 'pos-mobile-giftcard-step6.png' },
    ],
  },
