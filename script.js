...
const CONTENT = {
  ...
  'pda-login': {
    ...
    steps: [
      { text: '<strong>판매사원 로그인</strong>을 클릭합니다.' },
      { text: '<strong>ID와 비밀번호</strong>를 입력하고 <strong>로그인</strong> 버튼을 클릭합니다.' },
    ],
  },
  ...
  'pda-preset': {
    ...
    videoUrl: 'https://youtu.be/T47OQJ9s4nY?si=ackShVSGSh2Yr14W',
    steps: [
      { text: '<strong>PRESET 확장</strong> 버튼을 클릭합니다.' },
      { text: '등록을 원하는 <strong>그룹을 선택</strong>합니다.' },
      { text: 'PRESET을 등록할 <strong>빈칸을 선택</strong>합니다.' },
      { text: '상품조회에서 <strong>품번코드, 세분류, 마진</strong>을 입력합니다.<br>(가격 미입력 시 추후 결제를 진행할 때 입력할 수 있습니다).' },
      { text: '<strong>PRESET을 등록</strong>합니다.' },
    ],
  },
  ...
  'pda-cash': {
    ...
    steps: [
      { text: '등록할 상품을 클릭합니다.' },
      { text: '상품의 금액을 입력하고 <strong>확인</strong>을 클릭합니다.' },
      { text: '등록된 상품을 확인하고 <strong>결제</strong>를 클릭합니다.' },
      { text: '<strong>현금결제</strong>를 클릭합니다.' },
      { text: '결제금액을 입력하고 <strong>추가</strong>를 클릭합니다.<br>(에누리 적용시 결제금액 입력 전 에누리 먼저 적용).' },
      { text: '<strong>결제</strong>를 클릭합니다.' },
      { text: '현금영수증 발행 시 증빙 구분 선택 후 고객번호 입력 후 <strong>확인</strong>을 클릭합니다.<br>(현금영수증 미발행 시 <strong>자진발급</strong> 클릭).' },
      { text: '주차정산 등을 확인 후 <strong>거래완료</strong>를 클릭합니다.' },
    ],
  },
  ...
  'pda-card': {
    ...
    steps: [
      ...
      { text: '상품의 금액을 입력하고 <strong>확인</strong>을 클릭합니다.' },
      { text: '등록된 상품을 확인하고 <strong>결제</strong>를 클릭합니다.' },
      { text: '카드를 <strong>삽입 혹은 센싱</strong>합니다.' },
      { text: '에누리 창이 뜨면 원하는 에누리를 선택합니다.' },
      { text: '결제 금액 및 할부 기간을 확인합니다.' },
      { text: '<strong>결제</strong>를 클릭합니다.' },
      { text: '고객의 <strong>전자서명</strong>을 등록합니다.' },
      { text: 'IC 카드 제거 후 <strong>거래완료</strong>를 클릭합니다.' },
    ],
  },
  ...
  'pda-lpay': {
    ...
    steps: [
      ...
      { text: '상품의 금액을 입력하고 <strong>확인</strong>을 클릭합니다.' },
      { text: '등록된 상품을 확인하고 <strong>결제</strong>를 클릭합니다.' },
      { text: '<strong>간편결제</strong>를 클릭합니다.' },
      { text: '<strong>L.pay</strong>를 클릭한 후 바코드를 <strong>스캔 혹은 수기입력</strong>합니다.<br>(에누리 적용시 에누리 클릭 후 적용).' },
      { text: '결제 금액, 할부 기간, 사용 포인트 확인 후 <strong>결제</strong>를 클릭합니다.' },
    ],
  },
  ...
  'pda-giftcard': {
    ...
    steps: [
      ...
      { text: '상품의 금액을 입력하고 <strong>확인</strong>을 클릭합니다.' },
      { text: '등록된 상품을 확인하고 <strong>결제</strong>를 클릭합니다.' },
      { text: '<strong>지류 상품권</strong>을 클릭합니다.' },
      { text: '상품권을 등록하고 <strong>추가</strong>합니다.<br>(롯데상품권: 상품권 번호 입력 혹은 바코드 인식, 타사상품권: 금종 및 매수 입력).' },
      { text: '<strong>결제</strong>를 클릭합니다.' },
      { text: '거스름을 위해 상품권 여분을 확인합니다.<br>(취소: 이전 화면으로 돌아가기, 확인: 상품권 종류 선택).' },
      { text: '거스름을 돌려받을 <strong>상품권 종류를 선택</strong>합니다.' },
      { text: '모바일상품권을 선택한 경우, 발행받을 <strong>고객 핸드폰 번호를 입력</strong>하고 고객에게 인증번호를 받아 입력하고 <strong>확인</strong>을 클릭합니다.' },
      { text: '지류상품권을 선택한 경우, <strong>상품권 스캔 혹은 번호 입력</strong> 후 <strong>확인</strong>을 클릭합니다.' },
    ],
  },
  ...
  'pda-mobile-giftcard': {
    ...
    steps: [
      ...
      { text: '상품의 금액을 입력하고 <strong>확인</strong>을 클릭합니다.' },
      { text: '등록된 상품을 확인하고 <strong>결제</strong>를 클릭합니다.' },
      { text: '<strong>기타결제</strong>를 클릭합니다.' },
      { text: '<strong>모바일 상품권</strong>을 클릭합니다.' },
      { text: '모바일 상품권을 <strong>스캔 혹은 번호 입력</strong>한 후 잔액을 확인합니다.' },
      { text: '결제금액을 입력하고 <strong>결제</strong>를 클릭합니다.' },
    ],
  },
  ...
  'pda-lpoint': {
    ...
    steps: [
      ...
      { text: '상품의 금액을 입력하고 <strong>확인</strong>을 클릭합니다.' },
      { text: '등록된 상품을 확인하고 <strong>결제</strong>를 클릭합니다.' },
      { text: '<strong>L.POINT</strong>를 클릭합니다.' },
      { text: '<strong>바코드 센싱, IC카드 삽입, MSR 센싱</strong>을 통해 L.POINT 정보를 등록합니다.' },
      { text: '고객정보 확인 후 <strong>기타결제</strong>를 클릭합니다.' },
      { text: '<strong>L.POINT</strong>를 선택합니다.' },
      { text: '사용 포인트를 입력하고 <strong>확인</strong>을 클릭합니다.' },
    ],
  },
  ...
  'pda-refund': {
    ...
    videoUrl: 'https://youtu.be/T47OQJ9s4nY?si=ackShVSGSh2Yr14W',
    steps: [
      { text: '<strong>반품등록</strong>을 클릭합니다.' },
      { text: '<strong>영수증 바코드 스캔</strong> 혹은 원거래 정보를 입력합니다.' },
      { text: '<strong>반품등록</strong>을 클릭합니다.' },
      { text: '결제정보를 확인하고 <strong>반품확정</strong>을 클릭합니다.' },
    ],
  },
};
